...
| 4f | **Richer character pack (optional)** — self-host Open Peeps / Humaaans / Open Doodles CC0 modular SVGs as composed scenes (beyond DiceBear hotlink avatars) if the flat pack still feels thin vs 29FORWARD | 2026-07-09 research | Licence-safe; prefer over AI gen; AI gen stays secondary (cost + no-raster-only) |
